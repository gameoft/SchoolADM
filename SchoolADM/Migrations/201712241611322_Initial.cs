namespace SchoolADM.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Address1 = c.String(nullable: false, maxLength: 250, fixedLength: true),
                        Address2 = c.String(),
                        City = c.String(),
                ...
                c => new
                    {
                        ...
                        StudentName = c.String(nullable: false, maxLength: 20, fixedLength: true),
                        Photo = c.Binary(),
                        Height = c.Decimal(precision: 2, scale: 2),
                        Weight = c.Single(nullable: false),
                    })
                .PrimaryKey(t => t.StudentId)
                .Index(t => t.StudentName, unique: true, name: "AK_Student_StudentName");
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Students", "AK_Student_StudentName");
